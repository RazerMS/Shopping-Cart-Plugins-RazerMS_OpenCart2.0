		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
						...
						<div class="col-sm-10">
							<select name="molpay_type" id="input-type" class="form-control">
								<?php
									...
									foreach($type as $m=>$n){?>
										<option value="<?php echo $m;?>" <?=($molpay_type == $m)? 'selected': ''?>> <?=$n?></option>
								<?php }?>
							</select>
							<?php if ($error_type) { ?>
				...
				<div>
					...
					<ol >
						<li style="padding:5px"> Login to <b><a href="https://www.onlinepayment.com.my/MOLPay/" target="_blank" >Fiuu merchant Admin</a></b> and go to <b style="color:red;">merchant profile</b>. </li>
						...
						<li style="padding:5px"> Put below url for <b style="color:red;">Notification URL</b> and tick <b style="color:red;">"Yes"</b> to <b style="color:red;">"Enable Notification URL with IPN"</b>.
